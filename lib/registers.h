...
#define PS_UNIT 15.6500400641025641   // 499.2 MHz(IEEE UWB Fund. Freq.)
                                      // Speed of DWM3000 timestamp counter = 499.2 Mhz * 128 = 63.9 GHz
                                      // 1 / 63.9 GHz = PS_UNIT(time of tick)
